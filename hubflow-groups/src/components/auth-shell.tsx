    ...
    <div className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-[#0b0718] px-4 py-10">
      ...
      <div className="dz-rise relative z-10 w-full max-w-sm">
        <div className="mb-8 flex flex-col items-center text-center">
          ...
          <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-brand-400">DevZap Groups</p>
        ...
        <p className="mt-6 text-center text-xs text-slate-500">VIP Growth OS</p>
      </div>
    </div>
  );
}
