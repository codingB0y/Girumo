...
// Coleção JSON simples em arquivo (MVP). Reutilizada por templates, ad-campaigns,
// broadcasts e schedules. Escrita atômica + lock por arquivo evitam corrupção e
// race entre engine (polling) e navegador. Migrar para Prisma depois.
