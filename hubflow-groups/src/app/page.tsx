...
export const metadata = {
  title: "DevZap Groups — Lote seus grupos de WhatsApp e venda mais, no automático",
  description:
...
// TODO Igor: troque pelo seu número de vendas (formato wa.me/55DDDNUMERO).
const WHATSAPP =
  "https://wa.me/5511999999999?text=" +
  encodeURIComponent("Oi! Quero saber como o DevZap Groups lota meus grupos e protege meu número.");
  ...
  return (
    <div className="min-h-screen bg-white text-slate-800">
        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between px-5 py-3">
          <div className="flex items-center gap-2.5">
            ...
            <div className="leading-tight">
              <p className="font-semibold tracking-tight text-slate-900">DevZap Groups</p>
              <p className="text-[11px] font-medium uppercase tracking-wide text-brand-500">VIP Growth OS</p>
            </div>
          </div>
      ...
      <section className="relative overflow-hidden bg-[#0b0718] text-white">
        ...
        <div className="relative mx-auto max-w-6xl px-5 py-20 text-center sm:py-28">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-lg text-white/70">
            O DevZap Groups conecta o SEU WhatsApp, traz revendedora nova, dispara suas ofertas e mostra
            quem comprou e quanto você vendeu. Tudo simples, do jeito do lojista — sem planilha, sem gestor caro.
          </p>
          <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
            <Cta href={WHATSAPP} big>
        ...
        <div className="relative mx-auto max-w-5xl px-5">
          <div className="text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-white/70">
              Se você sabe usar o WhatsApp, sabe usar o DevZap Groups. Tudo no celular, em português de
      ...
      <Section muted>
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mt-3 text-slate-500">
            A maioria das ferramentas só dispara mensagem. O DevZap Groups traz revendedora nova todo mês,
      ...
      <Section muted>
        ...
        <h2 className="text-center text-2xl font-bold tracking-tight text-slate-900 sm:text-3xl">
          Por que DevZap Groups e não do jeito de sempre?
        </h2>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-slate-100 text-left">
                ...
                <th className="px-3 py-3 text-center font-semibold text-brand-700">DevZap Groups</th>
              </tr>
            </thead>
      ...
      <Section muted>
        <div className="mx-auto max-w-3xl rounded-2xl border border-slate-200/70 bg-white p-8 text-center shadow-card sm:p-10">
          ...
          <p className="text-lg font-medium leading-relaxed text-slate-700 sm:text-xl">
            ...
            se o grupo crescia ou vendia, e sem um jeito de trazer revendedora nova. O DevZap Groups
            nasceu pra resolver isso — feito por quem vive o atacado de moda, não por quem só entende de
            tecnologia.&rdquo;
          </p>
          <p className="mt-5 text-sm font-semibold text-slate-900">Time DevZap Groups</p>
        </div>
      </Section>
      ...
      <Section muted>
        ...
        <div className="mx-auto mt-8 max-w-3xl space-y-3">
          {[
            ...
            ["É difícil de usar? Não entendo de tecnologia.", "Se você usa WhatsApp, usa o DevZap Groups. É tudo no celular, simples, em português, com modelos prontos e suporte no WhatsApp."],
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#15102b] via-[#1b1340] to-[#2a1d63] py-20 text-white">
        ...
        <div className="relative mx-auto max-w-3xl px-5 text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-white/70">
            ...
            DevZap Groups resolve os três. Conecta em 2 minutos, no seu próprio WhatsApp.
          </p>
      ...
      <footer className="border-t border-slate-200 bg-white">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-3 px-5 py-8 text-sm text-slate-400 sm:flex-row">
          <p className="flex items-center gap-2">
            ...
            DevZap Groups · Feito por quem entende atacado de moda
          </p>
          <div className="flex gap-4">
            <Link href="/login" className="hover:text-slate-700">Entrar</Link>
            <a href={WHATSAPP} className="hover:text-slate-700">Falar no WhatsApp</a>
          </div>
        </div>
      </footer>
    </div>
