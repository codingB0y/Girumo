...
import { nudgeConnectEmail, trialEndingEmail, disconnectAlertEmail } from "@/lib/email/templates";
...
export async function GET(req: Request) {
  ...
  const results = { nudge_sent: 0, trial_sent: 0, disconnect_sent: 0, errors: 0 };
