...
export default function PaginaDetalhePage() {
  ...
  if (!detail) {
    return (
      <div className="mx-auto max-w-[1200px] px-4 py-6 sm:px-6">
        <div className="rounded-xl border border-volt-950/[0.06] bg-paper-0 px-5 py-16 text-center text-sm text-aco/60">
          {error ?? "Carregando..."}
        </div>
      </div>
    );
  ...
  return (
    <div className="mx-auto max-w-[1200px] space-y-6 px-4 py-6 sm:px-6">
      ...
      <div className="flex flex-wrap items-center gap-2">
        {page.status !== "published" ? (
          ...
          <button
            ...
            disabled={busy}
            className="inline-flex items-center gap-2 rounded-xl border border-volt-950/10 bg-paper-0 px-4 py-2.5 text-sm font-medium text-volt-950 transition hover:border-atencao/50 disabled:opacity-60"
          >
        ...
        <button
          ...
          className="inline-flex items-center gap-2 rounded-xl border border-volt-950/10 bg-paper-0 px-4 py-2.5 text-sm font-medium text-volt-950 transition hover:border-cobalt-500/50"
        >
      ...
      {/* leads */}
      <div className="rounded-xl border border-volt-950/[0.06] bg-paper-0 shadow-card">
      ...
      {valuesV2 ? (
        <div className="space-y-3">
          <section
            ...
            className="rounded-xl border border-volt-950/[0.06] bg-paper-0 p-5 shadow-card"
          >
      ...
      {values ? (
        <details className="rounded-xl border border-volt-950/[0.06] bg-paper-0 shadow-card">
...
function MetricCard({
  ...
  return (
    <div className="rounded-xl border border-volt-950/[0.06] bg-paper-0 p-5 shadow-card">
