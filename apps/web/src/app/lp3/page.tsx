...
export const metadata = {
  ...
  description:
    "A Girumo lota seus grupos de WhatsApp com revendedores, publica sua oferta em todos de uma vez e mostra de qual grupo veio cada venda. Feito por quem levou um atacado de R$5 mil a R$350 mil por mês.",
