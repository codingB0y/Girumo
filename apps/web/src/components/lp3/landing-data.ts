...
export const PLANS: Plan[] = [
  {
    ...
    short: "1 celular · até 5 grupos",
    features: [
      "1 celular conectado",
      "Até 5 grupos gerenciados",
      "Disparo de texto e imagem",
      "Agendamento de mensagens",
      "Aviso por e-mail se o celular desconectar",
      "Quem pede pra sair nunca é recontatado",
    ],
    featured: false,
  },
  {
    ...
    short: "2 celulares · grupos ilimitados",
    features: [
  ...
  },
  {
    ...
    short: "2 celulares · setup assistido",
    features: [
      "2 celulares conectados",
      "Tudo do Growth",
