    ...
    <div className={cn("space-y-4", className)}>
      ...
      <div className="rounded-xl border border-line-200 bg-paper-0 p-4">
        ...
        <div className="mt-3 grid gap-3 sm:grid-cols-3">
          <div>
            <label className="font-data text-12 uppercase tracking-wider text-slate-600">Data</label>
            <input
              type="date"
              value={date}
              onChange={(e) => setDate(e.target.value)}
              min={new Date().toISOString().split("T")[0]}
              className="mt-1 w-full rounded-lg border border-line-200 bg-canvas-100 px-3 py-2 text-sm text-volt-950 focus:border-cobalt-500 focus:outline-none"
            />
          </div>
          <div>
            <label className="font-data text-12 uppercase tracking-wider text-slate-600">Horário</label>
            <div className="mt-1 flex items-center gap-2">
              ...
              <input
                ...
                className="flex-1 rounded-lg border border-line-200 bg-canvas-100 px-3 py-2 text-sm text-volt-950 focus:border-cobalt-500 focus:outline-none"
              />
            </div>
          </div>
          <div>
            <label className="font-data text-12 uppercase tracking-wider text-slate-600">Recorrência</label>
            <div className="mt-1 flex items-center gap-2">
        ...
        {pendingPayload && (!date || !time) && (
          <div className="mt-3 rounded-xl bg-aviso-fundo px-3 py-2 text-xs text-atencao">
