...
export function LpNav({ signupUrl }: { signupUrl: string }) {
  ...
  return (
    <header className="fixed inset-x-0 top-4 z-50 px-4">
      <div
        className={cn(
          "lp3-nav mx-auto flex max-w-5xl items-center justify-between rounded-[var(--radius-card)] px-5 py-3",
      ...
      >
        ...
        <div className="flex items-center gap-4">
          ...
          <a href={signupUrl} className="lp3-btn lp3-btn-accent px-5 py-2.5 text-sm">
