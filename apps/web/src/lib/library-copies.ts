/**
 * Biblioteca de copies (P1.14) — modelos de mensagem prontos pro lojista de atacado
 * copiar e postar nos grupos. Módulo puro (sem I/O), navegável por categoria.
 *
 ...
 * Copy aprovada pelo Igor (29/jul); dá pra expandir com conteúdo da Mega Stock depois.
 */
...
export const LIBRARY_CATEGORIES: { id: LibraryCategory; label: string; hint: string }[] = [
  { id: "novidade", label: "Novidade", hint: "Anunciar peça que acabou de chegar." },
