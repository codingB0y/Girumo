...
> Status 2026-06-24: documento legado. O schema alvo atual vive em `infra/migrations`,
> `infra/rls` e `docs/FASE_4_BANCO.md`. Prisma, Neon e Asaas foram superados por
> Supabase Postgres/RLS/Auth/Storage e Stripe.
